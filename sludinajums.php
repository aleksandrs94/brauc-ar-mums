          <?php
              ...
              $page_name = $_GET['page_id'];
                ...
                $result = $mysqli->query("SELECT * FROM users JOIN braucejs ON users.id=braucejs.users_id WHERE braucejs.id=$page_name") or die($mysqli->error());
                  ...
                  $pagee_name = $_GET['pagee_id'];

                  $result2 = $mysqli->query("SELECT * FROM users JOIN brauciens ON users.id=brauciens.users_id WHERE brauciens.id=$pagee_name") or die($mysqli->error());
